...
class LinksValidators:
    ...
    def run_pre_link_validator(self, simulation: TopologySimulation, link: Link):
        ...
        """
        node_exists = self.validate_link_nodes_exist_in_topology(simulation.topology, link)
    ...
    def is_packet_loss_valid(self, simulation: TopologySimulation):
        ...
        """
        if simulation.links_execution_state.failed_links == 0 or simulation.links_execution_state.processed_links == 0:
            return True
        
        current_packet_loss_percent = simulation.links_execution_state.failed_links / simulation.links_execution_state.processed_links
    ...
    def run_post_link_validator(self, simulation: TopologySimulation):
        ...
        Args:
            simulation (TopologySimulation): The simulation object.
        """
        self.is_packet_loss_valid(simulation)
        self.logger.info(f"Post-link validation completed for simulation {simulation.sim_id}")