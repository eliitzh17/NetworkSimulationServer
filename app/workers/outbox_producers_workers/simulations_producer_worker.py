...
from app.messageBroker.producers.simulations_producer import SimulationsProducer
...
def main():
    async def setup_and_run():
        ...
        logger = LoggerManager.get_logger("simulations_producer_worker")  
        logger.info("Starting new simulations producer worker")
